...
declare const UpdateAccessGrantsLocationCommand_base: {
    new (input: UpdateAccessGrantsLocationCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateAccessGrantsLocationCommandInput, UpdateAccessGrantsLocationCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateAccessGrantsLocationCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateAccessGrantsLocationCommandInput, UpdateAccessGrantsLocationCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
