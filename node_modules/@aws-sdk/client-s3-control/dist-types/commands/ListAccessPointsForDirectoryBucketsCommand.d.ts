...
declare const ListAccessPointsForDirectoryBucketsCommand_base: {
    new (input: ListAccessPointsForDirectoryBucketsCommandInput): import("@smithy/smithy-client").CommandImpl<ListAccessPointsForDirectoryBucketsCommandInput, ListAccessPointsForDirectoryBucketsCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListAccessPointsForDirectoryBucketsCommandInput]): import("@smithy/smithy-client").CommandImpl<ListAccessPointsForDirectoryBucketsCommandInput, ListAccessPointsForDirectoryBucketsCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
