...
declare const ListAccessGrantsLocationsCommand_base: {
    new (input: ListAccessGrantsLocationsCommandInput): import("@smithy/smithy-client").CommandImpl<ListAccessGrantsLocationsCommandInput, ListAccessGrantsLocationsCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListAccessGrantsLocationsCommandInput]): import("@smithy/smithy-client").CommandImpl<ListAccessGrantsLocationsCommandInput, ListAccessGrantsLocationsCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
