...
declare const UpdateStorageLensGroupCommand_base: {
    new (input: UpdateStorageLensGroupCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateStorageLensGroupCommandInput, UpdateStorageLensGroupCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateStorageLensGroupCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateStorageLensGroupCommandInput, UpdateStorageLensGroupCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
