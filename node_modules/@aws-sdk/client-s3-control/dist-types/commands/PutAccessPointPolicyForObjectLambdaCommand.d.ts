...
declare const PutAccessPointPolicyForObjectLambdaCommand_base: {
    new (input: PutAccessPointPolicyForObjectLambdaCommandInput): import("@smithy/smithy-client").CommandImpl<PutAccessPointPolicyForObjectLambdaCommandInput, PutAccessPointPolicyForObjectLambdaCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: PutAccessPointPolicyForObjectLambdaCommandInput): import("@smithy/smithy-client").CommandImpl<PutAccessPointPolicyForObjectLambdaCommandInput, PutAccessPointPolicyForObjectLambdaCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
