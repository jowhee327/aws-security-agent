...
declare const DeleteAccessGrantsInstanceResourcePolicyCommand_base: {
    new (input: DeleteAccessGrantsInstanceResourcePolicyCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteAccessGrantsInstanceResourcePolicyCommandInput, DeleteAccessGrantsInstanceResourcePolicyCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DeleteAccessGrantsInstanceResourcePolicyCommandInput]): import("@smithy/smithy-client").CommandImpl<DeleteAccessGrantsInstanceResourcePolicyCommandInput, DeleteAccessGrantsInstanceResourcePolicyCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
