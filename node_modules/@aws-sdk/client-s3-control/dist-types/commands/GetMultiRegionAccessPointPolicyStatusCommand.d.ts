...
declare const GetMultiRegionAccessPointPolicyStatusCommand_base: {
    new (input: GetMultiRegionAccessPointPolicyStatusCommandInput): import("@smithy/smithy-client").CommandImpl<GetMultiRegionAccessPointPolicyStatusCommandInput, GetMultiRegionAccessPointPolicyStatusCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetMultiRegionAccessPointPolicyStatusCommandInput): import("@smithy/smithy-client").CommandImpl<GetMultiRegionAccessPointPolicyStatusCommandInput, GetMultiRegionAccessPointPolicyStatusCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
