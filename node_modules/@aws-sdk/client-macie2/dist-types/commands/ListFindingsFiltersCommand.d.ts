...
import type { ListFindingsFiltersRequest, ListFindingsFiltersResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const ListFindingsFiltersCommand_base: {
    new (input: ListFindingsFiltersCommandInput): import("@smithy/smithy-client").CommandImpl<ListFindingsFiltersCommandInput, ListFindingsFiltersCommandOutput, Macie2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListFindingsFiltersCommandInput]): import("@smithy/smithy-client").CommandImpl<ListFindingsFiltersCommandInput, ListFindingsFiltersCommandOutput, Macie2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
