...
import type { ListAllowListsRequest, ListAllowListsResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const ListAllowListsCommand_base: {
    new (input: ListAllowListsCommandInput): import("@smithy/smithy-client").CommandImpl<ListAllowListsCommandInput, ListAllowListsCommandOutput, Macie2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListAllowListsCommandInput]): import("@smithy/smithy-client").CommandImpl<ListAllowListsCommandInput, ListAllowListsCommandOutput, Macie2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
