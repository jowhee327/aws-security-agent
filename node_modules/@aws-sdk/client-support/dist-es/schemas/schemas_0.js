...
export var Communication$ = [3, n0, _Co,
    0,
    [_cI, _b, _sB, _tC, _aS],
    [0, 0, 0, 0, () => AttachmentSet]
];
export var CommunicationTypeOptions$ = [3, n0, _CTO,
    0,
    [_t, _sH, _dWS],
...
export var DescribeAttachmentResponse$ = [3, n0, _DARe,
    0,
    [_at],
    [() => Attachment$]
];
export var DescribeCasesRequest$ = [3, n0, _DCR,
    0,
    [_cIL, _dI, _aT, _bT, _iRC, _nT, _mR, _l, _iC],
    [64 | 0, 0, 0, 0, 2, 0, 1, 0, 2]
];
export var DescribeCasesResponse$ = [3, n0, _DCRe,
    0,
    [_ca, _nT],
    [() => CaseList, 0]
];
export var DescribeCommunicationsRequest$ = [3, n0, _DCRes,
    0,
    [_cI, _bT, _aT, _nT, _mR],
    [0, 0, 0, 0, 1], 1
];
export var DescribeCommunicationsResponse$ = [3, n0, _DCResc,
    0,
    [_com, _nT],
    [() => CommunicationList, 0]
];
export var DescribeCreateCaseOptionsRequest$ = [3, n0, _DCCOR,
    0,
    [_iT, _sC, _l, _cC],
    [0, 0, 0, 0], 4
];
export var DescribeCreateCaseOptionsResponse$ = [3, n0, _DCCORe,
    0,
    [_lA, _cT],
...
export var DescribeSeverityLevelsResponse$ = [3, n0, _DSLRe,
    0,
    [_sL],
    [() => SeverityLevelsList]
];
export var DescribeSupportedLanguagesRequest$ = [3, n0, _DSLRes,
    0,
    [_iT, _sC, _cC],
    [0, 0, 0], 3
];
export var DescribeSupportedLanguagesResponse$ = [3, n0, _DSLResc,
    0,
    [_sLu],
    [() => SupportedLanguagesList]
];
export var DescribeTrustedAdvisorCheckRefreshStatusesRequest$ = [3, n0, _DTACRSR,
    0,
    [_cIh],
    [[() => StringList, 0]], 1
];
export var DescribeTrustedAdvisorCheckRefreshStatusesResponse$ = [3, n0, _DTACRSRe,
    0,
    [_sta],
    [() => TrustedAdvisorCheckRefreshStatusList], 1
];
export var DescribeTrustedAdvisorCheckResultRequest$ = [3, n0, _DTACRR,
    0,
    [_cIhe, _l],
    [0, 0], 1
];
export var DescribeTrustedAdvisorCheckResultResponse$ = [3, n0, _DTACRRe,
    0,
    [_r],
    [[() => TrustedAdvisorCheckResult$, 0]]
];
export var DescribeTrustedAdvisorChecksRequest$ = [3, n0, _DTACR,
    0,
    [_l],
    [0], 1
];
export var DescribeTrustedAdvisorChecksResponse$ = [3, n0, _DTACRe,
    0,
    [_ch],
    [[() => TrustedAdvisorCheckList, 0]], 1
];
export var DescribeTrustedAdvisorCheckSummariesRequest$ = [3, n0, _DTACSR,
    0,
    [_cIh],
    [[() => StringList, 0]], 1
];
...
export var RefreshTrustedAdvisorCheckRequest$ = [3, n0, _RTACR,
    0,
    [_cIhe],
    [0], 1
];
export var RefreshTrustedAdvisorCheckResponse$ = [3, n0, _RTACRe,
    0,
    [_st],
    [() => TrustedAdvisorCheckRefreshStatus$], 1
];
export var ResolveCaseRequest$ = [3, n0, _RCR,
    0,
    [_cI],
    [0]
];
export var ResolveCaseResponse$ = [3, n0, _RCRe,
    0,
    [_iCS, _fCS],
    [0, 0]
];
...
export var SeverityLevel$ = [3, n0, _SL,
    0,
    [_co, _n],
    [0, 0]
];
export var SupportedHour$ = [3, n0, _SH,
    0,
    [_sT, _eTn],
    [0, 0]
];
export var SupportedLanguage$ = [3, n0, _SLu,
    0,
    [_co, _l, _di],
    [0, 0, 0]
];
...
export var TrustedAdvisorCheckDescription$ = [3, n0, _TACD,
    0,
    [_i, _n, _de, _cate, _me],
    [0, 0, 0, 0, [() => StringList, 0]], 5
];
export var TrustedAdvisorCheckRefreshStatus$ = [3, n0, _TACRS,
    0,
    [_cIhe, _st, _mUNR],
    [0, 0, 1], 3
];
export var TrustedAdvisorCheckResult$ = [3, n0, _TACR,
    0,
...
export var TrustedAdvisorCheckSummary$ = [3, n0, _TACS,
    0,
    [_cIhe, _ti, _st, _rS, _cSS, _hFR],
    [0, 0, 0, () => TrustedAdvisorResourcesSummary$, () => TrustedAdvisorCategorySpecificSummary$, 2], 5
];
export var TrustedAdvisorCostOptimizingSummary$ = [3, n0, _TACOS,
    0,
    [_eMS, _ePMS],
    [1, 1], 2
];
export var TrustedAdvisorResourceDetail$ = [3, n0, _TARD,
    0,
    [_st, _rI, _me, _re, _iS],
    [0, 0, [() => StringList, 0], 0, 2], 3
];
export var TrustedAdvisorResourcesSummary$ = [3, n0, _TARS,
    0,
    [_rP, _rF, _rIe, _rSe],
    [1, 1, 1, 1], 4
];
