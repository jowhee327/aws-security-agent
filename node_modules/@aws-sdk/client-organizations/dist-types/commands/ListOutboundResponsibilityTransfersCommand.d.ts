...
import type { ListOutboundResponsibilityTransfersRequest, ListOutboundResponsibilityTransfersResponse } from "../models/models_0";
...
declare const ListOutboundResponsibilityTransfersCommand_base: {
    new (input: ListOutboundResponsibilityTransfersCommandInput): import("@smithy/smithy-client").CommandImpl<ListOutboundResponsibilityTransfersCommandInput, ListOutboundResponsibilityTransfersCommandOutput, OrganizationsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ListOutboundResponsibilityTransfersCommandInput): import("@smithy/smithy-client").CommandImpl<ListOutboundResponsibilityTransfersCommandInput, ListOutboundResponsibilityTransfersCommandOutput, OrganizationsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
