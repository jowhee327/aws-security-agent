...
import type { ListInboundResponsibilityTransfersRequest, ListInboundResponsibilityTransfersResponse } from "../models/models_0";
...
declare const ListInboundResponsibilityTransfersCommand_base: {
    new (input: ListInboundResponsibilityTransfersCommandInput): import("@smithy/smithy-client").CommandImpl<ListInboundResponsibilityTransfersCommandInput, ListInboundResponsibilityTransfersCommandOutput, OrganizationsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ListInboundResponsibilityTransfersCommandInput): import("@smithy/smithy-client").CommandImpl<ListInboundResponsibilityTransfersCommandInput, ListInboundResponsibilityTransfersCommandOutput, OrganizationsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
